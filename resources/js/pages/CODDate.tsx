                            ...
                            <div className="flex justify-center lg:justify-start">
                                <DayPicker
                                    ...
                                    classNames={{
                                        ...
                                        root: "text-[12px] sm:text-lg lg:text-[24px]",
                                        nav: "flex top-20 justify-around sm:justify-between mt-4 sm:mt-6 lg:mt-8",
                                        nav_button_previous: "absolute left-2 top-1/2 -translate-y-1/2 z-10 hover:bg-gray-100 rounded-full p-2 transition-colors",
                                        nav_button_next: "absolute right-2 top-1/2 -translate-y-1/2 z-10 hover:bg-gray-100 rounded-full p-2 transition-colors",
                                        caption_label: "flex justify-center items-center -mt-6 sm:-mt-8 lg:-mt-10 font-semibold",
                                        day: "p-0 sm:p-2.5 lg:p-3.5",
                                        month: "w-full",
